      ...
      <div className="flex flex-col text-center px-5 py-3">
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-3 sm:grid-cols-2 xs:grid-cols-1 gap-4">
            <div className='bg-slate-200 hover:bg-gray-300 duration-300 w-64 h-49 rounded-md text-start p-4 pt-5 flex flex-col justify-between'>
                ...
                <Link to='/education' className='text-xs flex items-center gap-2.5 text-gray-400 mt-2.5 hover:text-gray-500 duration-300'>Read more <i className='material-icons'>arrow_right_alt</i> </Link>                
            </div>
            <div className='bg-slate-200 hover:bg-gray-300 duration-300 w-64 h-49 rounded-md text-start p-4 pt-5 flex flex-col justify-between'>
                ...
                <Link to='/experiance' className='text-xs flex items-center gap-2.5 text-gray-400 mt-2.5 hover:text-gray-500 duration-300'>Read more <i className='material-icons'>arrow_right_alt</i> </Link>
            </div>
            <div className='bg-slate-200 hover:bg-gray-300 duration-300 w-64 h-49 rounded-md text-start p-4 pt-5 flex flex-col justify-between'>
                <i className='material-icons text-3xl'>monitoring</i>
                <p className='mt-2'>Current</p>
                <p className='mt-4'>Freelancer</p>
                <Link to='/current' className='text-xs flex items-center gap-2.5 text-gray-400 mt-2.5 hover:text-gray-500 duration-300'>Read more <i className='material-icons'>arrow_right_alt</i> </Link>
            </div>
        </div>
        </div>
      </div>
