  ...
  return (
    <div className='flex justify-center items-center pb-5 py-[90px]'>
      <div className="flex flex-col text-center px-5 py-3 w-full">
        <p className='text-xs m-0'>Now i'm</p>
        ...
        <hr className='my-6' />
        <div className="flex flex-col text-center px-5 py-3 w-full">
       <p className='text-xs m-0'>What my side</p>
       <h1 className='text-4xl mb-5'>Tools</h1>
            <div className='w-full sm:w-4/5 md:w-3/5 lg:w-3/6 rounded mx-auto bg-gray-200'>
                <div className='flex justify-center flex-wrap p-5 py-6 gap-3'>
                    <div>
                        <p className='border-2 border-slate-400 bg-slate-300 py-1.5 rounded-md px-4 m-0'>Git</p>
                    </div>
                    <div>
                        <p className='border-2 border-slate-400 bg-slate-300 py-1.5 rounded-md px-4 m-0'>Postman</p>
                    </div>
                    <div>
                        <p className='border-2 border-slate-400 bg-slate-300 py-1.5 rounded-md px-4 m-0'>Figma</p>
                    </div>
                    <div>
                        <p className='border-2 border-slate-400 bg-slate-300 py-1.5 rounded-md px-4 m-0'>GitHub</p>
                    </div>
