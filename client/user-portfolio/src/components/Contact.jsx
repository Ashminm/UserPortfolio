            ...
            <div className="w-full mt-[80px]">
                <form action="">
                   ...
                   <input type="email" className='py-3 px-4 border border-black w-[48%] text-sm outline-green-600 bg-transparent rounded-md' placeholder='Enter your email' name="" id="" />
                    ...
                    <div className="g-recaptcha" data-sitekey="6LfHsn8qAAAAAGoJ3PjJVZCnVarkUHjB9lUXu3XT"></div>
                   <div className="flex justify-center mt-6">
                    <button type='submit' className='bg-zinc-800 hover:bg-zinc-700 duration-300 text-white flex items-center gap-2 px-4 py-1.5 sm:px-8 sm:py-3 text-sm rounded-full'>Submit now<i className="material-icons">arrow_right_alt</i></button>
                   </div>
                </form>
            </div>
      </div>
